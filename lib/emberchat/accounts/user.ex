defmodule Emberchat.Accounts.User do
  use Ecto.Schema
  ...
  @doc """
  A user changeset for registration with email and username.
  """
  ...
  defp validate_username(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:username, Emberchat.Repo)
  ...
  """
  def valid_password?(%Emberchat.Accounts.User{hashed_password: hashed_password}, password)
