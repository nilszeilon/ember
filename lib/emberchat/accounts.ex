defmodule Emberchat.Accounts do
  @moduledoc """
  ...
  alias Emberchat.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Emberchat.Accounts.User.username_changeset/3` for a list of supported options.
  ...
  See `Emberchat.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Emberchat.Accounts.User.password_changeset/3` for a list of supported options.
