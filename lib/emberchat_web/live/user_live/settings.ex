defmodule EmberchatWeb.UserLive.Settings do
  use EmberchatWeb, :live_view

  on_mount {EmberchatWeb.UserAuth, :require_sudo_mode}
  ...
  def handle_event("update_username", params, socket) do
    ...
    case Accounts.update_user_username(user, user_params) do
      {:ok, updated_user} ->
        ...
        username_changeset = Accounts.change_user_username(updated_user, %{}, validate_unique: false)
        {:noreply, socket |> put_flash(:info, info) |> assign(:username_form, to_form(username_changeset))}
