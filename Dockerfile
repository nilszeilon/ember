...
#   - https://hub.docker.com/_/debian/tags?name=bookworm-20240513-slim - for the release image
#   - https://pkgs.org/ - resource for finding needed packages
#   - Ex: docker.io/hexpm/elixir:1.16.3-erlang-25.3.2.12-debian-bookworm-20240513-slim
#
